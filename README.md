...
The Public Interest Technology University Network (PIT-UN) initiative aims to advance the field of public interest technology. However, there is currently a lack of subject matter experts in this area, making it challenging to identify and categorize relevant resources effectively. There are various websites and resources explaining the outcomes and goals of the PIT-UN initiative, but the process of tagging books as PIT-related has been arbitrary and subjective. To address this issue, the goal of this project is to develop a quantitative method to evaluate and score the compatibility of book descriptions with PIT keywords. This approach aims to bring consistency and objectivity to the categorization task, ensuring that the identified books genuinely align with the principles and objectives of the PIT-UN initiative.
